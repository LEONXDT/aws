...
<body>
  <div id="background-text">I LOVE YOU • I LOVE YOU • I LOVE YOU • I LOVE YOU •</div>
  ...
  <script>
    ...
    function createHeartShape() {
      ...
      for (let i = 0; i < steps; i++) {
        ...
        points.push({ x: posX + 2, y: posY + 2 }); // نقطتين بدل نقطة واحدة
      }
      return points;
    }
